...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    payload_version SMALLINT    NOT NULL DEFAULT 0,
    ...
    vin_count       SMALLINT    NOT NULL DEFAULT 0,
    vout_count      SMALLINT    NOT NULL DEFAULT 0
);
...
CREATE TABLE IF NOT EXISTS tx_vouts (
    ...
    output_type     SMALLINT    NOT NULL DEFAULT 0,
